...
from models.classifier_time_aware_mean import * # PointNet classifier is from here
...
model = PointNetMeanWithTimeEmbedding(k=args.num_classes, feature_transform=True).to(args.device)
