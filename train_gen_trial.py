...
parser.add_argument('--lr', type=float, default=5e-4) # This seems high?
parser.add_argument('--weight_decay', type=float, default=0)
parser.add_argument('--max_grad_norm', type=float, default=10)
parser.add_argument('--end_lr', type=float, default=1e-4)
parser.add_argument('--sched_start_epoch', type=int, default=200*THOUSAND) # so it only starts adjusting the LR once we hit 200k iterations - that's pretty wild
parser.add_argument('--sched_end_epoch', type=int, default=400*THOUSAND) # We end training after 400k iterations. On A100 this is about 17 hours with 8 seconds / 50 iterations
...
parser.add_argument('--max_iters', type=int, default=200000)  #  float('inf'))
